...
local messages = {
	...
	"Dev just dropped Trench War 2!!!",
	"Dev just dropped Trench War 2 and it goes hard.",
	"Dev just dropped Trench War 2 — no exploiters this time.",
	"Dev just dropped Trench War 2 and it's already better than Trench War.",
	"Dev just dropped Trench War 2!!! New features, no cheats.",
	"Dev just dropped Trench War 2 — finally, a clean game.",
	"Dev just dropped Trench War 2 and it's already cooking.",
	"Dev just dropped Trench War 2!!! Get in now.",
	"Dev just dropped Trench War 2 — and it actually works.",
	"Dev just dropped Trench War 2 and banned every exploiter.",
	"Dev just dropped Trench War 2 — full of updates, not bugs.",
	"Dev just dropped Trench War 2!!! Say goodbye to cheaters.",
	"Dev just dropped Trench War 2 and it's straight fire.",
	"Dev just dropped Trench War 2 — fresh code, real dev.",
	"Dev just dropped Trench War 2!!! Get out of Trench War already.",
	"Dev just dropped Trench War 2 and it’s way more fun.",
	"Dev just dropped Trench War 2 — it’s legit now.",
	"Dev just dropped Trench War 2 and it’s clean as hell.",
	"Dev just dropped Trench War 2!!! You’re missing out if you’re not in.",
	"Dev just dropped Trench War 2 and it’s full of new gear.",
	"Dev just dropped Trench War 2 — no more skids.",
	"Dev just dropped Trench War 2!!! This one’s actually fair.",
	"Dev just dropped Trench War 2 and it’s got way more features.",
	"Dev just dropped Trench War 2 — no lag, no nonsense.",
	"Dev just dropped Trench War 2!!! Built to be better.",
	"Dev just dropped Trench War 2 and it slaps way harder.",
	"Dev just dropped Trench War 2 — updated, secured, insane.",
	"Dev just dropped Trench War 2!!! Cleanest launch yet.",
	"Dev just dropped Trench War 2 and it’s already popping off.",
	"Dev just dropped Trench War 2 — say less, join now."
}
